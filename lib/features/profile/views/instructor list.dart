...
class InstructorListView extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              const Center(
                child: Column(
                  children: [
                    Text("Instructors", style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildInstructorProfileCard(String name, String tag, String img, String phone, String email) {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: Colors.white,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(name, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF003D4D))),
                const SizedBox(height: 5),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                  decoration: BoxDecoration(color: const Color(0xFF003D4D), borderRadius: BorderRadius.circular(4)),
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Row(
              children: [
                Text("Download ", style: TextStyle(fontSize: 9, color: Colors.white)),
  ...
  Widget _buildSectionTitle(String title) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF003D4D))),
        const SizedBox(height: 4),
