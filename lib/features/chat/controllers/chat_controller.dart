...
class ChatController extends GetxController {
  ...
  var userList = [
    ...
    {"name": "Kamrul Islam", "lastMsg": "Thanks!", "time": "Monday", "image": "https://i.pravatar.cc/150?u=4", "online": false},
  ].obs;
  ...
  var currentMessages = [
    ...
    {"text": "Sure, I'll send it to you shortly.", "isMe": false, "time": "10:06 AM"},
  ].obs;
