...
class EditReturnBottomSheet extends StatefulWidget {
  ...
  const EditReturnBottomSheet({super.key, required this.data, required this.onUpdate});
...
class _EditReturnBottomSheetState extends State<EditReturnBottomSheet> {
  ...
  void initState() {
    ...
    returnDateController = TextEditingController(text: widget.data['returnDate']);
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text("Edit Return", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              TextField(controller: rollController, decoration: const InputDecoration(labelText: "Student Roll", hintText: "Enter your roll number...", border: OutlineInputBorder())),
