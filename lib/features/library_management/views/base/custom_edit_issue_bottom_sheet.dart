...
class EditIssueBottomSheet extends StatefulWidget {
  ...
  const EditIssueBottomSheet({super.key, required this.issue, required this.onUpdate});
...
class _EditIssueBottomSheetState extends State<EditIssueBottomSheet> {
  ...
  void initState() {
    ...
    issueDateController = TextEditingController(text: widget.issue['issueDate']);
    returnDateController = TextEditingController(text: widget.issue['returnDate']);
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text("Edit Issue", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              TextField(controller: titleController, decoration: const InputDecoration(labelText: "Book Title", hintText: "Enter your book title", border: OutlineInputBorder())),
              ...
              const SizedBox(height: 12),
              TextField(controller: issueDateController, decoration: const InputDecoration(labelText: "Issue Date", hintText: "dd/mm/yyyy", border: OutlineInputBorder())),
              const SizedBox(height: 12),
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: const Text("Update Issue",style: TextStyle(color: Colors.white),),
                    ),
                  ),
                ],
              ),
